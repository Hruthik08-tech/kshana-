                ...
                <div className="w-full md:w-1/2 p-10 sm:p-14 flex flex-col justify-center bg-white z-10 relative">
                    <div className="mb-10 opacity-0 animate-fade-in-up delay-100">
                        ...
                        <p className="text-base body leading-relaxed opacity-0 animate-fade-in-up delay-200">
                            Sign in to catch the moments happening right now
                        </p>
                    </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-2.5 opacity-0 animate-fade-in-up delay-300">
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#" className="text-xs label text-delight-blue hover:text-deep-delight transition-colors">Forgot password?</a>
                            </div>
                            <div className="relative">
                                <input 
                                    type="password" 
                                    ...
                                    className="w-full px-4 py-3.5 rounded-xl bg-cloud-white border-2 border-soft-breeze text-midnight-navy placeholder:text-midnight-navy/40 font-medium" 
                                    placeholder="••••••••" 
                                    required 
                                />
                            </div>
                    ...
                    <div className="mt-8 text-center text-sm font-medium text-midnight-navy/60 opacity-0 animate-fade-in-up delay-300">
                        Don't have an account? <Link to="/signup" className="font-bold text-delight-blue font-body hover:text-deep-delight transition-colors">Sign up</Link>
                    </div>
                </div>
            </div>
        </div>
